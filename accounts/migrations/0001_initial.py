    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=100, null=True, verbose_name='addess')),
                ('pofileUsage', models.CharField(blank=True, choices=[('BUY', 'BUY'), ('SELL', 'SELL'), ('BOTH', 'BOTH')], max_length=15, null=True, verbose_name='profile usage')),
